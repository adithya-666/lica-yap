                            ...
                            <div class="py-5">
                                ...
                                <div class="d-flex justify-content-between mb-5">
                                    ...
                                    <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0">
                                        ...
                                        <!--end::Svg Icon-->
                                        <input type="text" data-kt-docs-table-filter="search-datatable-tat" class="form-control form-control-sm form-control-solid w-250px ps-15" placeholder="Search" />
                                    </div>
                                    <!--end::Search-->
                                    <!--begin::Group actions-->
                                ...
                                <table class="table gy-1 align-middle table-striped px-0 datatable-ajax" id="datatables">
                                    <thead>
                                        <tr class="text-start text-gray-600 fw-bolder fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="text-start" width="8%">Date</th>
...
<script src="{{asset('js/report/report_tat_cito/index.js')}}"></script>
<script src="{{asset('js/report/report_tat_cito/datatable.js')}}"></script>
